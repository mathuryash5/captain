...
def student_data():
	...
	db.session.add(Student(usn = "01FB15ECS019", name="Yash Mathur", email="notyash.mathur@gmail.com", branch="CSE", semester=7, section="C"))
	...
	db.session.add(Student(usn = "01FB15ECS022", name="Saksham Arya", email="notsaksham.arya@gmail.com", branch="CSE", semester=5, section="C"))
...
def team_data():
	...
	db.session.add(Team(course_code = "UE15CS201", session_id = "1", usn_list = {"member_1" : "Anirudh Gupta", "member_2" : "Anubhav Agarwal", "member_3" : "Rohan Agarwal"}))
	db.session.add(Team(course_code = "UE15CS201", session_id = "2", usn_list = {"member_1" : "Prasanna Rajan", "member_2" : "Yasser Nizam", "member_3" : "Gaurav Kothari"}))
	db.session.add(Team(course_code = "UE15CS201", session_id = "3", usn_list = {"member_1" : "Anant Singh Mann", "member_2" : "Dilsher Brar", "member_3" : "Abhinav Kejriwal"}))
	db.session.add(Team(course_code = "UE15CS202", session_id = "4", usn_list = {"member_1" : "Anirudh Gupta", "member_2" : "Anubhav Agarwal", "member_3" : "Rohan Agarwal"}))
	db.session.add(Team(course_code = "UE15CS202", session_id = "5", usn_list = {"member_1" : "Prasanna Rajan", "member_2" : "Yasser Nizam", "member_3" : "Gaurav Kothari"}))
	db.session.add(Team(course_code = "UE15CS202", session_id = "6", usn_list = {"member_1" : "Anant Singh Mann", "member_2" : "Dilsher Brar", "member_3" : "Abhinav Kejriwal"}))
	db.session.add(Team(course_code = "UE15CS203", session_id = "7", usn_list = {"member_1" : "Anirudh Gupta", "member_2" : "Anubhav Agarwal", "member_3" : "Rohan Agarwal"}))
	db.session.add(Team(course_code = "UE15CS203", session_id = "8", usn_list = {"member_1" : "Prasanna Rajan", "member_2" : "Yasser Nizam", "member_3" : "Gaurav Kothari"}))
	db.session.add(Team(course_code = "UE15CS203", session_id = "9", usn_list = {"member_1" : "Anant Singh Mann", "member_2" : "Dilsher Brar", "member_3" : "Abhinav Kejriwal"}))
	db.session.add(Team(course_code = "UE15CS301", session_id = "10", usn_list = {"member_1" : "Advait Jha", "member_2" : "Atharva Matta", "member_3" : "Aditya Vir Roy"}))
	db.session.add(Team(course_code = "UE15CS301", session_id = "11", usn_list = {"member_1" : "Aditya Gandhi", "member_2" : "Mrigank Khemka", "member_3" : "Vatsal Agarwal"}))
	db.session.add(Team(course_code = "UE15CS301", session_id = "12", usn_list = {"member_1" : "Saksham Arya", "member_2" : "Josh Pasricha", "member_3" : "Arjun Singh Mann"}))
	db.session.add(Team(course_code = "UE15CS302", session_id = "13", usn_list = {"member_1" : "Advait Jha", "member_2" : "Atharva Matta", "member_3" : "Aditya Vir Roy"}))
	db.session.add(Team(course_code = "UE15CS302", session_id = "14", usn_list = {"member_1" : "Aditya Gandhi", "member_2" : "Mrigank Khemka", "member_3" : "Vatsal Agarwal"}))
	db.session.add(Team(course_code = "UE15CS302", session_id = "15", usn_list = {"member_1" : "Saksham Arya", "member_2" : "Josh Pasricha", "member_3" : "Arjun Singh Mann"}))
	db.session.add(Team(course_code = "UE15CS303", session_id = "16", usn_list = {"member_1" : "Advait Jha", "member_2" : "Atharva Matta", "member_3" : "Aditya Vir Roy"}))
	db.session.add(Team(course_code = "UE15CS303", session_id = "17", usn_list = {"member_1" : "Aditya Gandhi", "member_2" : "Mrigank Khemka", "member_3" : "Vatsal Agarwal"}))
	db.session.add(Team(course_code = "UE15CS303", session_id = "18", usn_list = {"member_1" : "Saksham Arya", "member_2" : "Josh Pasricha", "member_3" : "Arjun Singh Mann"}))
	db.session.add(Team(course_code = "UE15CS401", session_id = "19", usn_list = {"member_1" : "Aditya Ramani", "member_2" : "Anvith Shetty", "member_3" : "Saket Golyan"}))
	db.session.add(Team(course_code = "UE15CS401", session_id = "20", usn_list = {"member_1" : "Aayushman Arora", "member_2" : "Rahil Arora" ,"member_3" : "Armaan Imaam"}))
	db.session.add(Team(course_code = "UE15CS401", session_id = "21", usn_list = {"member_1" : "Yash Mathur", "member_2" : "Varuni Sutrave", "member_3" : "Srishti Mishra"}))
	db.session.add(Team(course_code = "UE15CS402", session_id = "22", usn_list = {"member_1" : "Aditya Ramani", "member_2" : "Anvith Shetty", "member_3" : "Saket Golyan"}))
	db.session.add(Team(course_code = "UE15CS402", session_id = "23", usn_list = {"member_1" : "Aayushman Arora", "member_2" : "Rahil Arora" ,"member_3" : "Armaan Imaam"}))
	db.session.add(Team(course_code = "UE15CS402", session_id = "24", usn_list = {"member_1" : "Yash Mathur", "member_2" : "Varuni Sutrave", "member_3" : "Srishti Mishra"}))
	db.session.add(Team(course_code = "UE15CS403", session_id = "25", usn_list = {"member_1" : "Aditya Ramani", "member_2" : "Anvith Shetty", "member_3" : "Saket Golyan"}))
	db.session.add(Team(course_code = "UE15CS403", session_id = "26", usn_list = {"member_1" : "Aayushman Arora", "member_2" : "Rahil Arora" ,"member_3" : "Armaan Imaam"}))
	db.session.add(Team(course_code = "UE15CS403", session_id = "27", usn_list = {"member_1" : "Yash Mathur", "member_2" : "Varuni Sutrave", "member_3" : "Srishti Mishra"}))
	db.session.commit()

def admin_data():
	db.session.add(Admin(roleno= '1', password= 'secret'))
	db.session.commit()