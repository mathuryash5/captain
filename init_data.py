...
def student_data():
	...
	db.session.add(Student(usn = "01FB15ECS340", name="Srishti Mishra", email="srishtimishra56@gmail.com", branch="CSE", semester=7, section="C"))
...
def teacher_data():
	...
	db.session.add(Teacher(f_id = "F000", name="Test Teacher", email="captain.se6@gmail.com", branch="CSE", position="Professor"))
	db.session.commit()
