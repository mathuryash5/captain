...
def student_data():
	...
	db.session.add(Student(usn = "01FB15ECS025", name="Shreyas Patil", email="Shreyas.Patil.mann@gmail.com", branch="CSE", semester=3, section="C"))
	db.session.add(Student(usn = "01FB15ECS026", name="Sujay Manjunath", email="Sujay.Manjunath@gmail.com", branch="CSE", semester=3, section="C"))
	db.session.add(Student(usn = "01FB15ECS027", name="Suman Champak", email="Suman.Champak@gmail.com", branch="CSE", semester=3, section="C"))
	db.session.commit()
...
def teacher_data():
	...
	db.session.add(Teacher(f_id = "F010", name="Mukesh Karanth", email="Mukesh.Karanth@gmail.com", branch="CSE", position="Professor"))
	db.session.commit()
...
def team_data():
	...
	db.session.add(Team(team_id = "1", course_code = "UE15CS201", session_id = "1", usn_list = "{member_1 = Anirudh Gupta, member_2 = Anubhav Agarwal, member_3 = Rohan Agarwal}", github_user = "Anirudh Gupta", github_repo = "https://github.com/AnirudhGupta/captain"))
	db.session.add(Team(team_id = "2", course_code = "UE15CS201", session_id = "2", usn_list = "{member_1 = Prasanna Rajan, member_2 = Yasser Nizam, member_3 = Gaurav Kothari}", github_user = "Prasanna Rajan", github_repo = "https://github.com/PrasannaRajan/captain"))
	db.session.add(Team(team_id = "3", course_code = "UE15CS201", session_id = "3", usn_list = "{member_1 = Anant Singh Mann, member_2 = Dilsher Brar, member_3 = Abhinav Kejriwal}", github_user = "Anant Singh Mann", github_repo = "https://github.com/AnantSinghMann/captain"))
	db.session.add(Team(team_id = "2", course_code = "UE15CS201", session_id = "28", usn_list = "{member_1 = Shreyas Patil, member_2 = Suman Champak, member_3 = Sujay Manjunath}", github_user = "Shreyas Patil", github_repo = "https://github.com/ShreyasPatil/captain"))
	db.session.add(Team(team_id = "4", course_code = "UE15CS202", session_id = "4", usn_list = "{member_1 = Anirudh Gupta, member_2 = Anubhav Agarwal, member_3 = Rohan Agarwal}", github_user = "Anirudh Gupta", github_repo = "https://github.com/AnirudhGupta/captain"))
	db.session.add(Team(team_id = "5", course_code = "UE15CS202", session_id = "5", usn_list = "{member_1 = Prasanna Rajan, member_2 = Yasser Nizam, member_3 = Gaurav Kothari}", github_user = "Prasanna Rajan", github_repo = "https://github.com/PrasannaRajan/captain"))
	db.session.add(Team(team_id = "6", course_code = "UE15CS202", session_id = "6", usn_list = "{member_1 = Anant Singh Mann, member_2 = Dilsher Brar, member_3 = Abhinav Kejriwal}", github_user = "Anant Singh Mann", github_repo = "https://github.com/AnantSinghMann/captain"))
	db.session.add(Team(team_id = "2", course_code = "UE15CS202", session_id = "29", usn_list = "{member_1 = Shreyas Patil, member_2 = Suman Champak, member_3 = Sujay Manjunath}", github_user = "Shreyas Patil", github_repo = "https://github.com/ShreyasPatil/captain"))
	db.session.add(Team(team_id = "7", course_code = "UE15CS203", session_id = "7", usn_list = "{member_1 = Anirudh Gupta, member_2 = Anubhav Agarwal, member_3 = Rohan Agarwal}", github_user = "Anirudh Gupta", github_repo = "https://github.com/AnirudhGupta/captain"))
	db.session.add(Team(team_id = "8", course_code = "UE15CS203", session_id = "8", usn_list = "{member_1 = Prasanna Rajan, member_2 = Yasser Nizam, member_3 = Gaurav Kothari}", github_user = "Prasanna Rajan", github_repo = "https://github.com/PrasannaRajan/captain"))
	db.session.add(Team(team_id = "9", course_code = "UE15CS203", session_id = "9", usn_list = "{member_1 = Anant Singh Mann, member_2 = Dilsher Brar, member_3 = Abhinav Kejriwal}", github_user = "Anant Singh Mann", github_repo = "https://github.com/AnantSinghMann/captain"))
	db.session.add(Team(team_id = "2", course_code = "UE15CS203", session_id = "30", usn_list = "{member_1 = Shreyas Patil, member_2 = Suman Champak, member_3 = Sujay Manjunath}", github_user = "Shreyas Patil", github_repo = "https://github.com/ShreyasPatil/captain"))
	db.session.add(Team(team_id = "10", course_code = "UE15CS301", session_id = "10", usn_list = "{member_1 = Advait Jha, member_2 = Atharva Matta, member_3 = Aditya Vir Roy}", github_user = "Advait Jha", github_repo = "https://github.com/AdvaitJha/captain"))
	db.session.add(Team(team_id = "11", course_code = "UE15CS301", session_id = "11", usn_list = "{member_1 = Aditya Gandhi, member_2 = Mrigank Khemka, member_3 = Vatsal Agarwal}", github_user = "Aditya Gandhi", github_repo = "https://github.com/AdityaGandhi/captain"))
	db.session.add(Team(team_id = "12", course_code = "UE15CS301", session_id = "12", usn_list = "{member_1 = Saksham Arya, member_2 = Josh Pasricha, member_3 = Arjun Singh Mann}", github_user = "Josh Pasricha", github_repo = "https://github.com/JoshPasricha/captain"))
	db.session.add(Team(team_id = "13", course_code = "UE15CS302", session_id = "13", usn_list = "{member_1 = Advait Jha, member_2 = Atharva Matta, member_3 = Aditya Vir Roy}", github_user = "Advait Jha", github_repo = "https://github.com/AdvaitJha/captain"))
	db.session.add(Team(team_id = "14", course_code = "UE15CS302", session_id = "14", usn_list = "{member_1 = Aditya Gandhi, member_2 = Mrigank Khemka, member_3 = Vatsal Agarwal}", github_user = "Aditya Gandhi", github_repo = "https://github.com/AdityaGandhi/captain"))
	db.session.add(Team(team_id = "15", course_code = "UE15CS302", session_id = "15", usn_list = "{member_1 = Saksham Arya, member_2 = Josh Pasricha, member_3 = Arjun Singh Mann}", github_user = "Josh Pasricha", github_repo = "https://github.com/JoshPasricha/captain"))
	db.session.add(Team(team_id = "16", course_code = "UE15CS303", session_id = "16", usn_list = "{member_1 = Advait Jha, member_2 = Atharva Matta, member_3 = Aditya Vir Roy}", github_user = "Advait Jha", github_repo = "https://github.com/AdvaitJha/captain"))
	db.session.add(Team(team_id = "17", course_code = "UE15CS303", session_id = "17", usn_list = "{member_1 = Aditya Gandhi, member_2 = Mrigank Khemka, member_3 = Vatsal Agarwal}", github_user = "Aditya Gandhi", github_repo = "https://github.com/AdityaGandhi/captain"))
	db.session.add(Team(team_id = "18", course_code = "UE15CS303", session_id = "18", usn_list = "{member_1 = Saksham Arya, member_2 = Josh Pasricha, member_3 = Arjun Singh Mann}", github_user = "Josh Pasricha", github_repo = "https://github.com/JoshPasricha/captain"))
	db.session.add(Team(team_id = "19", course_code = "UE15CS401", session_id = "19", usn_list = "{member_1 = Aditya Ramani, member_2 = Anvith Shetty, member_3 = Saket Golyan}", github_user = "Aditya Ramani", github_repo = "https://github.com/AdityaRamani/captain"))
	db.session.add(Team(team_id = "20", course_code = "UE15CS401", session_id = "20", usn_list = "{member_1 = Aayushman Arora, member_2 = Rahil Arora ,member_3 = Armaan Imaam}", github_user = "Rahil Arora", github_repo = "https://github.com/RahilArora/captain"))
	db.session.add(Team(team_id = "21", course_code = "UE15CS401", session_id = "21", usn_list = "{member_1 = Yash Mathur, member_2 = Varuni Sutrave, member_3 = Srishti Mishra}", github_user = "Yash Mathur", github_repo = "https://github.com/mathuryash5/captain"))
	db.session.add(Team(team_id = "22", course_code = "UE15CS402", session_id = "22", usn_list = "{member_1 = Aditya Ramani, member_2 = Anvith Shetty, member_3 = Saket Golyan}", github_user = "Aditya Ramani", github_repo = "https://github.com/AdityaRamani/captain"))
	db.session.add(Team(team_id = "23", course_code = "UE15CS402", session_id = "23", usn_list = "{member_1 = Aayushman Arora, member_2 = Rahil Arora ,member_3 = Armaan Imaam}", github_user = "Rahil Arora", github_repo = "https://github.com/RahilArora/captain"))
	db.session.add(Team(team_id = "24", course_code = "UE15CS402", session_id = "24", usn_list = "{member_1 = Yash Mathur, member_2 = Varuni Sutrave, member_3 = Srishti Mishra}", github_user = "Yash Mathur", github_repo = "https://github.com/mathuryash5/captain"))
	db.session.add(Team(team_id = "25", course_code = "UE15CS403", session_id = "25", usn_list = "{member_1 = Aditya Ramani, member_2 = Anvith Shetty, member_3 = Saket Golyan}", github_user = "Aditya Ramani", github_repo = "https://github.com/AdityaRamani/captain"))
	db.session.add(Team(team_id = "26", course_code = "UE15CS403", session_id = "26", usn_list = "{member_1 = Aayushman Arora, member_2 = Rahil Arora ,member_3 = Armaan Imaam}", github_user = "Rahil Arora", github_repo = "https://github.com/RahilArora/captain"))
	db.session.add(Team(team_id = "27", course_code = "UE15CS403", session_id = "27", usn_list = "{member_1 = Yash Mathur, member_2 = Varuni Sutrave, member_3 = Srishti Mishra}", github_user = "Yash Mathur", github_repo = "https://github.com/mathuryash5/captain"))
