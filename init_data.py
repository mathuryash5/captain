...
def student_data():
	...
	db.session.add(Student(usn = "01FB15ECS027", name="Abhinav Kejriwal", email="notabhinav.kejriwal@gmail.com", branch="CSE", semester=3, section="C"))
	db.session.add(Student(usn = "01FB15ECS030", name="Dilsher Brari", email="notdilsher.brar@gmail.com", branch="CSE", semester=3, section="C"))
	db.session.add(Student(usn = "01FB15ECS031", name="Saksham Arya", email="saksham.arya@gmail.com", branch="CSE", semester=5, section="C"))
	db.session.add(Student(usn = "01FB15ECS032", name="Yash Upadhyay", email="yash.upadhyay@gmail.com", branch="CSE", semester=7, section="C"))
	db.session.add(Student(usn = "01FB15ECS033", name="Abhinav Kejriwal", email="abhinav.kejriwal@gmail.com", branch="CSE", semester=7, section="C"))
